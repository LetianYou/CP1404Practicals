...
pickup_numbers = [num for num in numbers if num > 9]
print(pickup_numbers)
...
pickup_last_name = [name.split()[1] for name in full_names if len(name) > 11]
pickup_last_name_with_string = ", ".join(pickup_last_name)
print(pickup_last_name_with_string)
